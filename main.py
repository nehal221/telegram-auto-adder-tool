...
def subscription_check():
    banner()
    print("\033[1;33mTo run this tool, subscribe to our YouTube channel first.\033[0m")
    print("1. Subscribe Channel")
    print("2. Already Subscribed")
    choice = input("Enter your choice (1/2): ")
    if choice == '1':
        webbrowser.open("https://youtube.com/@nehal_dark_trap?si=sjL1_iRpN7ByqneE")
...
def main_menu():
    while True:
        ...
        print("3. Add Members to Telegram Group\033[0m")
